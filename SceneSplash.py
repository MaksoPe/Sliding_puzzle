...
class SceneSplash(pyghelpers.Scene):
    def __init__(self, window):
        ...
        self.WelcomeText = pygwidgets.DisplayText(self.window,
                                                  ...
                                                  textColor=WHITE,
                                                  fontName="cmr10",
                                                  width=WINDOW_WIDTH_HEIGHT-50-50,
                                                  justified="center")
